...
{
	// PULSE OVERRIDE: L4D2's FlashlightState_t has no ortho block and no
	// m_fBrightnessScale - 24 bytes less than this header, which put
	// m_pSpotlightTexture at 0x64 instead of its real 0x4C. Confirmed by
	// dumping the live struct: 0x2C..0x38 read as the attenuation floats
	// (0, 100, 0, 750) and 0x3C..0x48 as m_Color (1,1,1,0), with the only
	// materialsystem-owned pointer at 0x4C.
